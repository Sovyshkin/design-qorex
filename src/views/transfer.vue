  ...
  <WalletScreen :title="t('transfer_page')" @back="walletStore.goBack()">
    ...
    <template v-else>
      ...
      <section class="form-card">
        ...
        <label><span>{{ t("select_amount") }}</span><div class="amount-field"><input v-model="amount" inputmode="decimal" placeholder="0.00" @input="normalizeAmount"><b>USDT</b></div></label>
