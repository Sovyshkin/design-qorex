...
<template>
  <div class="transfer-view">
    ...
    >
      <div class="transfer-view__state-card transfer-view__state-card--fallback">
        <div class="transfer-view__shield">
          <img :src="safetyIcon" alt="Security" />
        </div>
        <h2>{{ t("require_2fa_title") }}</h2>
        <p>{{ t("require_2fa_description") }}</p>
        <div class="transfer-view__state-actions">
          <button class="transfer-view__primary" type="button" @click="goToTwoFactorSetup">
            {{ t("enable_2fa") }}
          </button>
          <button class="transfer-view__secondary" type="button" @click="walletStore.goBack()">
            {{ t("go_back") }}
          </button>
        </div>
      </div>
