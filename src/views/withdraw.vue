    ...
    <WalletScreen :title="t('withdraw_page')" @back="walletStore.goBack()">
      ...
      <template v-else>
        ...
        <section class="withdraw-card amount-card">
          ...
          <label class="amount-control"><input v-model="amount" type="number" min="5" :max="balance" placeholder="0"><b>USDT</b></label>
