...
.wallet-tab { position: relative; width: 58px; min-height: 56px; border-radius: 18px; display: grid; place-items: center; gap: 3px; color: #64748b; transition: transform .18s ease, color .18s ease; }
...
.wallet-tab.active { color: #2563eb; transform: translateY(-2px); }
.wallet-tab.active .wallet-icon { opacity: 1; transform: translateY(-1px); filter: drop-shadow(0 5px 8px rgba(37,99,235,.22)); }
.wallet-tab.active span:not(.active-dot) { font-weight: 750; color: #2563eb; }
...
.wallet-tab.active .active-dot { background: #2563eb; box-shadow: 0 0 0 4px rgba(37,99,235,.12); transform: translateY(1px); }
